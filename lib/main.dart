                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Initialization failed. The error is shown below.',
                        ),
  ...
  ThemeData _theme(Brightness brightness) {
    ...
    return ThemeData(
      ...
      navigationBarTheme: NavigationBarThemeData(
        ...
        elevation: 0,
        backgroundColor:
            dark ? const Color(0xFF111016) : Colors.white.withValues(alpha: .96),
    ...
    return StreamBuilder<AuthState>(
      ...
      builder: (_, snapshot) {
        ...
        if (recoveringPassword) {
          return const email_auth.PasswordRecoveryPage();
        }
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: const [
          ...
          NavigationDestination(
            ...
            selectedIcon: Icon(Icons.circle, size: 20),
            label: 'Updates',
          ),
          NavigationDestination(
